...
export function EA11Panel({ isOpen, onClose, initialEleicaoCd }: EA11PanelProps) {
  ...
  return (
    <>
      ...
      <div
        ref={panelRef}
        className={`fixed inset-y-0 right-0 z-50 w-[90vw] md:w-[600px] bg-white dark:bg-slate-900 shadow-2xl overflow-y-auto border-l border-gray-200 dark:border-slate-800 flex flex-col ${isClosing ? 'animate-slide-out-right' : 'animate-slide-in-right'}`}
      >
